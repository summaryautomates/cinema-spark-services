      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen py-20">
        ...
        >
          ...
          <div className="relative w-full max-w-2xl brain-container">
            ...
            <div
              className="absolute top-1/2 left-1/2 w-24 h-px bg-gradient-to-r from-transparent via-cyan-400/30 to-transparent animate-pulse transform rotate-45 -translate-x-12 translate-y-4"
