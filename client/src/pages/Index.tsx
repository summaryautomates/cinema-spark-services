...
const Index = () => {
  ...
  const strategicServices = [
    {
      ...
      description:
        "Transform your business with strategic AI implementation roadmaps and expert guidance.",
      features: [
    ...
    },
    {
      ...
      description:
        "Leverage AI to supercharge your sales and marketing performance with data-driven insights.",
      features: [
    ...
    },
    {
      ...
      description:
        "Build a commanding personal brand that establishes you as an industry thought leader.",
      features: [
        "Brand Strategy",
        "Content Planning",
  ...
  const developmentServices = [
    {
      ...
      description:
        "Bespoke AI models tailored to your specific business requirements and use cases.",
      features: [
    ...
    },
    {
      ...
      description:
        "Seamlessly integrate AI capabilities with your existing business infrastructure.",
      features: [
        "API Development",
        "System Architecture",
        "Data Pipeline Setup",
    ...
    },
    {
      ...
      description:
        "Full-stack development of modern web applications, mobile apps, and SaaS platforms.",
      features: [
        "Modern Web Apps",
        "Mobile Applications",
        "SaaS Platforms",
    ...
    },
    {
      ...
      description:
        "Stunning user interfaces that captivate users and drive engagement.",
      features: [
    ...
    },
    {
      ...
      description:
        "Intelligent automation agents that streamline your business processes.",
      features: [
        "Process Automation",
    ...
    },
    {
      ...
      description:
        "Advanced conversational AI solutions for customer service and engagement.",
      features: [
  ...
  const contentServices = [
    {
      ...
      description:
        "AI-powered content creation for newsletters, blogs, articles, and marketing materials.",
      features: [
    ...
    },
    {
      ...
      description:
        "Compelling case studies and testimonials that showcase your success stories.",
      features: [
    ...
    },
    {
      ...
      description:
        "Professional photography and advanced photo editing services.",
      features: [
        "Studio Photography",
        "Product Photography",
    ...
    },
    {
      ...
      description:
        "High-quality video production and post-production services.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive press kits that effectively communicate your brand story.",
      features: [
        "Brand Assets",
        "Press Releases",
        "Media Guidelines",
    ...
    },
    {
      ...
      description:
        "Professional CV and resume creation that gets you noticed by top employers.",
      features: [
  ...
  const marketingServices = [
    ...
    },
    {
      ...
      description:
        "Strategic WhatsApp marketing with organic and inorganic member boosting.",
      features: [
        "Group Setup",
        "Member Acquisition",
        "Content Strategy",
    ...
    },
    {
      ...
      description:
        "Build thriving communities that boost brand visibility and engagement.",
      features: [
        "Community Strategy",
        "Engagement Programs",
        "Brand Advocacy",
  ...
  const dataServices = [
    {
      ...
      description:
        "Advanced data analytics powered by AI to unlock actionable business insights.",
      features: [
        "Predictive Analytics",
        "Data Visualization",
    ...
    },
    {
      ...
      description:
        "Intelligent automation for ongoing support and repetitive task management.",
      features: [
        "Process Automation",
  ...
  const salesServices = [
    {
      ...
      description:
        "Strategic content marketing that drives engagement and conversions.",
      features: [
        "Content Strategy",
        "SEO Optimization",
        "Lead Generation",
    ...
    },
    {
      ...
      description:
        "Professional representation at industry events and conference showcasing.",
      features: [
        "Event Planning",
        "Booth Management",
        "Networking Strategy",
    ...
    },
    {
      ...
      description:
        "Strategic partnerships that expand your reach and create new opportunities.",
      features: [
    ...
    },
    {
      ...
      description:
        "Direct marketing campaigns that convert prospects into customers.",
      features: [
        "Campaign Design",
        "Segmentation",
        "Automation",
    ...
    },
    {
      ...
      description:
        "Data-driven advertising campaigns across Meta, LinkedIn, and Google platforms.",
      features: [
        "Campaign Management",
    ...
    },
    {
      title: "Sponsorships",
      description:
        "Strategic sponsorship opportunities that increase brand visibility and credibility.",
      features: [
    ...
    },
    {
      ...
      description:
        "Advanced website visitor tracking and management for lead generation.",
      features: [
        "Visitor Analytics",
        "Lead Scoring",
        "Behavior Tracking",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 text-center hover-scale bg-card/50 backdrop-blur-sm border-border/50">
              ...
              <p className="text-muted-foreground">
                Every solution is built with AI at its core, ensuring
                future-ready implementations that scale with your business
                needs.
              </p>
            </Card>
            ...
            <Card className="p-8 text-center hover-scale bg-card/50 backdrop-blur-sm border-border/50">
              ...
              <p className="text-muted-foreground">
                Our team of AI specialists, developers, and strategists bring
                years of experience across diverse industries and cutting-edge
                technologies.
              </p>
            </Card>
            ...
            <Card className="p-8 text-center hover-scale bg-card/50 backdrop-blur-sm border-border/50">
              ...
              <p className="text-muted-foreground">
                Fast-track your AI transformation with our proven methodologies
                and accelerated development processes that deliver results
                quickly.
              </p>
            </Card>
          </div>
